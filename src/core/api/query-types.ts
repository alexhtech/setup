...
export type Request<R, V> = (document: DocumentNode, variables: V | undefined, headers?: HeadersInit) => Promise<R>;

export type QueryFn<R = any, V = any> = (request: Request<R, V>, variables: V, headers?: HeadersInit) => Promise<R>;
